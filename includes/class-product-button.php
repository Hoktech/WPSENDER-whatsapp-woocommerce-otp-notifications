...
class HokTech_Product_Button {
    ...
    public function get_button_html($product, $args = []) {
        ...
        $product_estimated_delivery = function_exists('hoktech_get_product_estimated_delivery')
            ? hoktech_get_product_estimated_delivery($product)
            : '';
        ...
        if ($is_floating || $button_shape === 'circle') {
            ...
            <a href="<?php echo $wa_url; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"
               ...
               data-product-estimated-delivery="<?php echo esc_attr($product_estimated_delivery); ?>"
    ...
    public function parse_product_message($template, $product) {
        ...
        $estimated_delivery = function_exists('hoktech_get_product_estimated_delivery')
            ? hoktech_get_product_estimated_delivery($product)
            : '';
